...
// CUDA 12.x provides __hmax_nan/__hmin_nan unconditionally (for all compute
// capabilities) via NV_IF_ELSE_TARGET in cuda_fp16.hpp, so only polyfill them
// here when building against older CUDA toolkits that lack them.
